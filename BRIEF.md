...
Операционный контур агентства недвижимости: лид приходит по любому каналу → менеджер квалифицирует → система фиксирует данные → в CRM появляется карточка → дальше подборка, просмотр, объявление, статусы и напоминания.

Источник: схема онбординга. Это брейншторм целиком: бот, лендинг, CRM, рассылка, фото, объявления, топики — всё часть одной картины.
...
рассылка / соцсети / площадки / телефон
     ...
     карточка продавца / покупателя
                ↓
     подборка → просмотр / новые объекты
```
...
**CRM.** Карточки продавца и покупателя, теги, статусы воронки, исходный текст и транскрипт, фото, ссылки на объявления, обещанные звонки.
...
```
квалификация → прислать подборку
                    ├─ да  → смотреть объект
                    └─ нет → дополнить подборку новыми объектами
```

Подборка, просмотр и дополнение новыми объектами — статусы той же карточки покупателя и действия бота/менеджера в одном контуре.
...
**Статусы.** Бот сам пишет, что происходит: карточка собрана, не хватает полей, ушла в CRM, ушла подборка, назначен просмотр, подборка дополнена, висит обещанный звонок.
...
Дальше по покупателю уходит подборка: согласился — смотреть объект, нет — бот и менеджер дополняют подборку. По продавцу собирается карточка объявления: юридический блок, адрес, цена, метраж, фото без чужого водяного знака.
